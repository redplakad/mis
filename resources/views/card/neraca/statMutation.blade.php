    ...
    <div class="card-header py-7">
        ...
        <div class="m-0">
            ...
            <div class="d-flex align-items-center mb-2">
                <!--begin::Title-->
                <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">Mutasi</span>
                <!--end::Title-->
                <!--begin::Label-->
            ...
            <!--end::Heading-->
            <!--begin::Description-->
            <span class="fs-6 fw-semibold text-gray-500">{{ date('d/m/Y')}} (Dalam Ribuan)</span>
            <!--end::Description-->
        </div>
        <!--end::Statistics-->
    </div>
    ...
    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">-114.711</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">934.193</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">203.652</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">1.113</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">276.189</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
