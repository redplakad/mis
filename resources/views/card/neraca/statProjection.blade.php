    ...
    <div class="card-header py-7">
        ...
        <div class="m-0">
            ...
            <div class="d-flex align-items-center mb-2">
                <!--begin::Title-->
                <span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">Proyeksi</span>
                <!--end::Title-->
                <!--begin::Label-->
            ...
            <!--end::Heading-->
            <!--begin::Description-->
            <span class="fs-6 fw-semibold text-gray-500">31/07/2024 (Dalam Ribuan)</span>
            <!--end::Description-->
        </div>
        <!--end::Statistics-->
    </div>
    ...
    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Laba/Rugi</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">455.555</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">7,621,250</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">6,996,248</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">2,721</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Number-->
                    <span class="text-gray-800 fw-bold fs-4 me-3">1,867,521</span>
                    <!--end::Number-->
                </div>
                <!--end::Wrapper-->
            </div>
