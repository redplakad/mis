...
<div class="card card-flush" style="background: linear-gradient(180deg, #E67E22 0%, #ce6f1c 100%); box-shadow: 0px 14px 40px 0px rgba(18, 54, 54, 0.2);">
    <!--begin::Header-->
    <div class="card-header align-items-center pt-6">
        ...
        <div class="card-title flex-column flex-grow-1">
            <span class="card-label fw-bold fs-3 text-white">Saldo Deposito</span>
        ...
        <div class="d-flex flex-stack flex-row-fluid">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-1">
                    <!--begin::Amount-->
                    <span class="fs-2hx fw-bold text-white me-2">{{ $deposit->balance }}</span>
                    <!--end::Amount-->
                </div>
                <!--end::Stats-->
            ...
            <!--begin::Chart-->
            <div id="kt_charts_pencairan" class="h-125px w-200px min-h-auto" style="min-height: 140px;">
                <!--end::Chart-->
            </div>
            <!--end::Wrapper-->
        </div>
