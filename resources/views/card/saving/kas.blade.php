...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-7 mb-3">
        ...
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Performa Kantor Cabang & Kas</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6">Total {{ $saving->account }} Rekening</span>
        </h3>
        <!--end::Title-->
