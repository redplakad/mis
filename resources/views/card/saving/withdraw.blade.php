    ...
    <div class="card-header align-items-center pt-6">
        ...
        <div class="symbol symbol-50px me-4">
            <div class="symbol-label bg-transparent rounded-lg"
                ...
                <i class="ki-duotone ki-minus-square fs-3x text-dark">
        ...
        <div class="card-title flex-column flex-grow-1">
            <span class="card-label fw-bold fs-3 text-dark">Tarik Tunai</span>
        ...
        <div class="d-flex flex-stack flex-row-fluid">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-1">
                    <!--begin::Amount-->
                    <span class="fs-2hx fw-bold text-dark me-2">782,024</span>
                    <!--end::Amount-->
                </div>
                <!--end::Stats-->
