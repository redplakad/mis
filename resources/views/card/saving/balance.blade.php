...
<div class="card card-flush" style="background: linear-gradient(180deg, #50B498 0%, #50B498 100%); box-shadow: 0px 14px 40px 0px rgba(18, 54, 54, 0.2);">
    <!--begin::Header-->
    <div class="card-header align-items-center pt-6">
        ...
        <div class="card-title flex-column flex-grow-1">
            <span class="card-label fw-bold fs-3 text-white">Saldo Tabungan</span>
        ...
        <div class="d-flex flex-stack flex-row-fluid">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-1">
                    <!--begin::Amount-->
                    <span class="fs-2hx fw-bold text-white me-2">{{ $saving->balance }}</span>
                    <!--end::Amount-->
                </div>
                <!--end::Stats-->
